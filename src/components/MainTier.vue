        ...
        <table style="height: 616px; width: 100%;" border="1">
            <tbody>
                <tr style="height: 22px;">
                    <td class="wysiwyg-text-align-center" style="width: 19.7831%; height: 22px;" colspan="2">티 어&nbsp;</td>
                    <td class="wysiwyg-text-align-center" style="width: 26.0354%; height: 22px;">RP 범위(변동될 수 있음)</td>
                    <td class="wysiwyg-text-align-center" style="width: 28.9503%; height: 22px;">입장료(1인/3인 사전 구성팀)</td>
                ...
                <tr style="height: 22px;">
                    ...
                    <td style="width: 26.7857%; height: 88px;" rowspan="4">&nbsp;</td>
                </tr>
                <tr style="height: 22px;">
